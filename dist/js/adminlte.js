...
// Get the button and the division elements
const changeroleIncome = document.getElementById("change-role-income-btn");
const roleIncomeForm = document.getElementById("role-income-form");

// Add an event listener to the button
changeroleIncome.addEventListener("click", () => {
  // Toggle the visibility of the division
  if (roleIncomeForm.style.display === "none") {
    roleIncomeForm.style.display = "block";
  } else {
    roleIncomeForm.style.display = "none";
  }
});